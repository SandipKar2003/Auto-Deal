...
# setting custome tab
st.set_page_config(page_title='Car sell website/predict car price', page_icon='image.png')
...
# Set background image using image.png
set_background("D:/C++ Code/check/as_bgc.jpg")


st.markdown("""
    <style>
    /* Global font and text color for entire app */
    .stApp {
        color: #e0f7fa;  /* Soft white-cyan */
        font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    }

    /* Input fields: number, select, etc. */
    input, select, textarea {
        color: #ffffff !important;              /* Bright white text */
        background-color: rgba(20, 20, 20, 0.85) !important;  /* Transparent dark */
        border: 1px solid #4dd0e1 !important;   /* Soft cyan border */
        border-radius: 5px;
        padding: 4px;
    }
    ...
    /* Input labels */
      label {
        color: #00ffff !important;  /* Bright neon cyan */
        font-weight: 800 !important;
        font-size: 40px !important;
        text-shadow: 2px 2px 4px #000000;  /* Shadow for better contrast on images */
    }

    /* Optional: tooltip icon color (the little ? circles) */
    .e1i5pmia3 {
        color: #00ffff !important;
    }

    /* Slider label and tooltip */
    .css-1aumxhk, .css-1y4p8pa {
    ...
    .stButton > button {
        ...
        background-image: linear-gradient(135deg, #00bcd4, #0097a7) !important;
        border: none;
        border-radius: 12px;
        padding: 0.6em 1.2em;
        font-weight: bold;
    ...
    .stButton > button:hover {
        background-image: linear-gradient(135deg, #4dd0e1, #00acc1) !important;
...
import os
file_path = os.path.join(os.path.dirname(__file__), "Car_cleaned_with_Model.csv")
...
# Loading both models
with st.spinner('🚕🛺🚙🚜🚚🚓🚗🚕 Hold on, the app is loading !! 🚕🛺🚙🚜🚚🚓🚗🚕'):
    model_forest = model_loader(r"D:\C++ Code\check\rf1_base_rf.pkl")
...
st.markdown("<h2 style='text-align: center;'>🚗  AutoDeal Predict Your Car price  🚗</h2>", unsafe_allow_html=True)
...
if predict: 
    ...
    if pred < 0:
        ...
        st.markdown(
            ...
            ">
                🚗 Your Best Price For The Car is: ${pred}
            </div>
            """,
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="http://127.0.0.1:5500/check/static/index.html" target="_blank">
                    <button style="
